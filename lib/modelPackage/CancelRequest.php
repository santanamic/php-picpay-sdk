...
class CancelRequest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $authorization_id ID da autorização que seu e-commerce recebeu na notificação de pedido pago. Caso o pedido não esteja pago, não é necessário enviar este parâmetro.
     *
     * @return $this
     */
