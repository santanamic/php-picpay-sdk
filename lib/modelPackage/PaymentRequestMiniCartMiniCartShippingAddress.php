<?php
/**
 * PaymentRequestMiniCartMiniCartShippingAddress
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PaymentRequestMiniCartMiniCartShippingAddress Class Doc Comment
 *
 * @category Class
 * @description Objeto contendo as informações do endereço de entrega.
 * @package  PicPay
*/
class PaymentRequestMiniCartMiniCartShippingAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentRequestMiniCart_miniCart_shippingAddress';
...
'postal_code' => 'getPostalCode'    ];
     ...
     * Sets country
     *
     * @param string $country Sigla do país.
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param string $state Siga do estado
     *
     * @return $this
     */
